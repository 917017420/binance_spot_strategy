    ...
    *,
    ...
    return LiveOrderPayload(
        ...
        metadata={
            ...
            'requested_position_size_pct': candidate.position_size_pct,
            'atr14_at_signal': candidate.indicators_1h.atr14,
            'structure_support_price': candidate.risk.invalidation_level,
            'runway_resistance_price': candidate.runway_resistance_price,
            'runway_upside_pct': candidate.runway_upside_pct,
            'reward_risk_ratio': candidate.reward_risk_ratio,
            'planned_initial_stop_price': candidate.planned_initial_stop_price,
            'planned_tp1_price': candidate.planned_tp1_price,
            'planned_tp2_price': candidate.planned_tp2_price,
            'exit_plan_notes': candidate.exit_plan_notes[:4],
